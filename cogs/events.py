...
class EventsCog(commands.Cog) :
  ...
  async def on_message(self, message) :
    if message.author.bot:
      ...
      if message.content.upper() == "TREE" or message.content.upper().startswith("TREE ") or message.content.upper().endswith(" TREE") or " TREE " in message.content.upper() :
      ...
      if "AHHH" in message.content.upper() :
      ...
      if message.content.upper() == "OLA" or message.content.upper().startswith("OLA ") or message.content.upper().endswith(" OLA") or " OLA " in message.content.upper() :
      ...
      if message.author.name == "antlerhunter" and  "AGATHA ALL ALONG" in message.content.upper():
